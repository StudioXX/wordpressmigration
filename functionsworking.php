...
function events_related_participants_update_value( $value, $post_id, $field  ) {
  ...
  //////////////// CREATE RELATIONSHIPS
	...
	if( is_array($value) ) {
      ...
      $translated_values[] = icl_object_id($post_id2, get_post_type($post_id2), false, $other_lang);
  ...
  ///////////// DELETE RELATIONSHIPS
	...
	if( is_array($old_value) ) {
      ...
      // process translation
      $post_id4translated = icl_object_id($post_id4, get_post_type($post_id4), false, $other_lang);
