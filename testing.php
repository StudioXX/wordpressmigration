...
//     wp_set_object_terms( $original_post_id, 31, 'type-event' );
//     wp_set_object_terms( $translated_post_id, 38, 'type-event' );
...
/////////////// test lookup array
$lookup = json_decode(file_get_contents('lookup.json'), true);
$result = in_array("english", $lookup) ? $lookup[$key] : $default;
print_r($lookup[Presentations][englishID])
?>